...
export function Footer() {
  const commitSha  = buildInfo.commitSha  ?? process.env.NEXT_PUBLIC_COMMIT_SHA  ?? 'local';
  const deployedAt = buildInfo.deployedAt ?? process.env.NEXT_PUBLIC_DEPLOYED_AT ?? 'local build';
