...
const DEMO_ACTIVITY: CCActivityPoint[] = [
  { id: 'd1', score: 2,  reason: 'Excellent class contribution', lessonName: 'English',  teacherName: 'Mr J Thompson', timestamp: new Date(Date.now() - 1  * 86400000).toISOString(), polarity: 'positive' },
  { id: 'd2', score: 1,  reason: 'Good homework submission',     lessonName: 'Maths',    teacherName: 'Mrs A Patel',   timestamp: new Date(Date.now() - 3  * 86400000).toISOString(), polarity: 'positive' },
  { id: 'd3', score: 1,  reason: 'Helping a classmate',         lessonName: 'Science',  teacherName: 'Dr R Evans',    timestamp: new Date(Date.now() - 5  * 86400000).toISOString(), polarity: 'positive' },
  { id: 'd4', score: -1, reason: 'Late to lesson',              lessonName: 'History',  teacherName: 'Miss L Davies', timestamp: new Date(Date.now() - 8  * 86400000).toISOString(), polarity: 'negative' },
  { id: 'd5', score: 2,  reason: 'Outstanding project work',    lessonName: 'Art',      teacherName: 'Mrs K Wilson',  timestamp: new Date(Date.now() - 12 * 86400000).toISOString(), polarity: 'positive' },
];
