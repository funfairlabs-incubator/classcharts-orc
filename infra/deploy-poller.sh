...
gcloud run deploy "$SERVICE" \
  ...
  --set-secrets="CLASSCHARTS_PARENT1_EMAIL=CLASSCHARTS_PARENT1_EMAIL:latest,CLASSCHARTS_PARENT1_PASSWORD=CLASSCHARTS_PARENT1_PASSWORD:latest,GCP_PROJECT_ID=GCP_PROJECT_ID:latest,GCS_BUCKET=GCS_BUCKET:latest,GCS_ALLOWED_USERS_PATH=GCS_ALLOWED_USERS_PATH:latest,GMAIL_CLIENT_ID=GMAIL_CLIENT_ID:latest,GMAIL_CLIENT_SECRET=GMAIL_CLIENT_SECRET:latest,GMAIL_REFRESH_TOKEN=GMAIL_REFRESH_TOKEN:latest,GCAL_REFRESH_TOKEN=GCAL_REFRESH_TOKEN:latest,GOOGLE_CLIENT_ID=GOOGLE_CLIENT_ID:latest,PUSHOVER_API_TOKEN=PUSHOVER_API_TOKEN:latest,PUSHOVER_USER_KEY=PUSHOVER_USER_KEY:latest,ANTHROPIC_API_KEY=ANTHROPIC_API_KEY:latest,ADMIN_EMAIL=ADMIN_EMAIL:latest"
